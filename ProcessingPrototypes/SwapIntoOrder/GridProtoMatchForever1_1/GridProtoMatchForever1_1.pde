...
void keyPressed() {
  ...
  if (keyCode == UP) MoveTiles(0, -1, colorIDToMove, false);
  else if (keyCode == DOWN) MoveTiles(0, 1, colorIDToMove, false);
  else if (keyCode == LEFT) MoveTiles(-1, 0, colorIDToMove, false);
  else if (keyCode == RIGHT) MoveTiles(1, 0, colorIDToMove, false);
