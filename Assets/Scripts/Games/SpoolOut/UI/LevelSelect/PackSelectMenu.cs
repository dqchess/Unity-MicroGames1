...
namespace SpoolOut {
    public class PackSelectMenu : BaseLevSelMenu {
        ...
        private void AddPackButton() {
            PackButton newObj = Instantiate(ResourcesHandler.Instance.spoolOut_levSelPackButton).GetComponent<PackButton>();
        ...
        private void AddLevelButton() {
            ...
            LevelButton newObj = Instantiate(ResourcesHandler.Instance.spoolOut_levSelLevelButton).GetComponent<LevelButton>();
