...
void keyPressed() {
  ...
  if (keyCode == UP) MoveTiles(0, -1, groupIDToMove);
  else if (keyCode == DOWN) MoveTiles(0, 1, groupIDToMove);
  else if (keyCode == LEFT) MoveTiles(-1, 0, groupIDToMove);
  else if (keyCode == RIGHT) MoveTiles(1, 0, groupIDToMove);
