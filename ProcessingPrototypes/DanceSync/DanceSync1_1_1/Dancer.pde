class Dancer {
  ...
  void Draw() {
    ...
    stroke(255, 50);
    strokeWeight(1);
    line(pos.x-colWidth*0.5,bounceApexY+size.y, pos.x+colWidth*0.5,bounceApexY+size.y);
  }
